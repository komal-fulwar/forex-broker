  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <header className="mb-4 sm:mb-6 md:mb-10">
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-primary tracking-tight">Add Liquidity</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 items-start">
          ...
          <div className="group relative overflow-hidden bg-white border-2 border-primary rounded-xl p-3.5 sm:p-4 md:p-5 cursor-pointer shadow-sm">
            <div className="flex justify-between items-start">
              <div className="flex gap-2.5 sm:gap-3 md:gap-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-background rounded-lg flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-primary text-lg sm:text-xl md:text-2xl">credit_card</span>
                </div>
                <div>
                  <h4 className="font-bold text-primary text-xs sm:text-sm md:text-base">Visa / Mastercard</h4>
        ...
        <div className="space-y-3 sm:space-y-4 md:space-y-6">
          <div className="bg-white rounded-xl p-4 sm:p-5 md:p-6 border border-outline-variant/15 shadow-sm">
            ...
            <div className="space-y-3 sm:space-y-4 md:space-y-5">
              ...
              <div className="pt-3 sm:pt-4 border-t border-outline-variant/10 space-y-2 sm:space-y-3">
                <div className="flex justify-between text-[11px] sm:text-xs"><span className="text-secondary">Fee (0%)</span><span className="font-bold text-primary">$0.00</span></div>
                <div className="flex justify-between text-[11px] sm:text-xs"><span className="text-secondary">Exchange Rate</span><span className="font-bold text-primary">1.00 USD</span></div>
                <div className="flex justify-between items-end pt-2">
                  <span className="text-[11px] sm:text-xs font-bold text-primary">Total to Receive</span>
                  <span className="text-lg sm:text-xl font-bold text-primary">$0.00</span>
                </div>
              </div>
              <button className="w-full bg-primary text-on-primary font-bold py-2.5 sm:py-3 md:py-4 rounded-xl text-xs sm:text-sm hover:opacity-90 transition-all flex items-center justify-center gap-2 mt-3 sm:mt-4">
                Continue to Review
          ...
          {/* Security Badge */}
          <div className="bg-background rounded-xl p-3 sm:p-4 flex gap-3 sm:gap-4 items-center">
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-white rounded-full flex items-center justify-center text-primary/40 shrink-0">
          ...
          <div className="flex gap-4 sm:gap-6 md:gap-10 no-scrollbar overflow-x-auto pb-2">
            {[
              ...
              <div key={pair} className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                <span className="text-[10px] sm:text-xs font-bold text-primary">{pair}</span>
...
function PaymentMethod({ icon, name, desc, processing, fee, limits }) {
  return (
    <div className="group bg-background hover:bg-surface-container-high transition-all rounded-xl p-3.5 sm:p-4 md:p-5 cursor-pointer border border-transparent">
      <div className="flex justify-between items-start">
        <div className="flex gap-2.5 sm:gap-3 md:gap-4">
          ...
          <div>
            <h4 className="font-bold text-primary opacity-80 group-hover:opacity-100 text-xs sm:text-sm md:text-base">{name}</h4>
