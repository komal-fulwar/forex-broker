  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 md:gap-8 items-start">
        {/* Main Form */}
        <section className="md:col-span-8 bg-white rounded-xl p-4 sm:p-6 md:p-10 shadow-sm border border-outline-variant/10">
          <div className="mb-4 sm:mb-6 md:mb-10">
            <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-primary mb-1.5 sm:mb-2 tracking-tight">Verify your identity</h1>
          ...
          <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6 md:mb-10">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              <button className="flex flex-col items-center justify-center p-3 sm:p-4 md:p-6 rounded-xl border-2 border-primary bg-surface-bright ring-1 ring-primary/5">
              ...
              <button className="flex flex-col items-center justify-center p-3 sm:p-4 md:p-6 rounded-xl border border-outline-variant/30 hover:bg-surface-container-low transition-colors">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="border-2 border-dashed border-outline-variant/50 rounded-xl p-6 sm:p-8 md:p-12 flex flex-col items-center justify-center text-center bg-background/30 hover:bg-background transition-all cursor-pointer group">
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-surface-container-highest flex items-center justify-center mb-3 sm:mb-4 md:mb-6 group-hover:scale-110 transition-transform">
                <span className="material-symbols-outlined text-primary text-xl sm:text-2xl md:text-3xl">cloud_upload</span>
              </div>
              <h3 className="text-xs sm:text-sm font-bold text-primary mb-1">Drag and drop document</h3>
          ...
          {/* Actions */}
          <div className="mt-6 sm:mt-8 md:mt-12 flex flex-col-reverse sm:flex-row items-center justify-between border-t border-outline-variant/10 pt-4 sm:pt-6 md:pt-8 gap-3 sm:gap-4">
            ...
            <button className="bg-primary text-on-primary px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm font-bold shadow-xl shadow-primary/10 hover:bg-primary/90 transition-all flex items-center gap-2 w-full sm:w-auto justify-center">
              Continue
        ...
        <aside className="md:col-span-4 space-y-3 sm:space-y-4 md:space-y-6">
          <div className="bg-background rounded-xl p-4 sm:p-5 md:p-6 border border-outline-variant/10">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-5 md:p-6 shadow-sm border border-outline-variant/10">
            ...
            <ul className="space-y-3 sm:space-y-4">
              {[
                ...
                <li key={text} className="flex items-start gap-2 sm:gap-3">
                  <span className="material-symbols-outlined text-green-600 text-base sm:text-lg shrink-0">check_circle</span>
          ...
          <div className="relative rounded-xl overflow-hidden h-28 sm:h-36 md:h-40 cursor-pointer border border-outline-variant/10 bg-primary">
            <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-primary/40 p-4 sm:p-5 md:p-6 flex flex-col justify-end">
              <span className="text-on-primary text-[9px] sm:text-[10px] font-bold uppercase tracking-widest mb-1 opacity-80">Privacy First</span>
              <h5 className="text-on-primary text-xs sm:text-sm font-bold leading-tight">Learn how BrokerPortal protects your digital assets.</h5>
            </div>
          </div>
        </aside>
      </div>
