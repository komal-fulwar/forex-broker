  ...
  return (
    <div className="w-full space-y-4 sm:space-y-6 md:space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
        <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 border border-outline-variant/10 shadow-sm flex items-center justify-between relative overflow-hidden">
          <div>
          ...
          <div className="absolute -bottom-3 -right-3 opacity-[0.03] pointer-events-none">
            <span className="material-symbols-outlined text-[80px] sm:text-[100px]" style={{ fontVariationSettings: "'FILL' 1" }}>trending_up</span>
          </div>
        </div>
        <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 border border-outline-variant/10 shadow-sm flex items-center justify-between relative overflow-hidden">
          <div>
          ...
          <div className="absolute -bottom-3 -right-3 opacity-[0.03] pointer-events-none">
            <span className="material-symbols-outlined text-[80px] sm:text-[100px]" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
        <div className="lg:col-span-2 space-y-3 sm:space-y-4 md:space-y-6">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 border border-outline-variant/10 shadow-sm relative overflow-hidden"
            style={{
              backgroundImage: 'radial-gradient(at 0% 0%, rgba(67, 97, 238, 0.04) 0px, transparent 50%), radial-gradient(at 100% 100%, rgba(67, 97, 238, 0.02) 0px, transparent 50%)'
            }}>
            <div className="relative z-10">
              <p className="text-[9px] sm:text-[10px] uppercase tracking-widest text-primary/60 mb-2 sm:mb-3 md:mb-4 font-bold">IB Opportunities</p>
            ...
            <div className="absolute -bottom-6 -right-6 opacity-[0.03] pointer-events-none">
              <span className="material-symbols-outlined text-[140px] sm:text-[180px]" style={{ fontVariationSettings: "'FILL' 1" }}>handshake</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 border border-outline-variant/10 shadow-sm relative overflow-hidden">
            ...
            <div className="space-y-2 sm:space-y-3 relative z-10">
              <div className="flex items-center justify-between p-2.5 sm:p-3 md:p-4 bg-background rounded-lg sm:rounded-xl md:rounded-2xl border border-outline-variant/5">
                ...
                <button className="text-[10px] sm:text-xs font-semibold text-primary hover:underline px-2 shrink-0">Complete</button>
              </div>
              <div className="flex items-center justify-between p-2.5 sm:p-3 md:p-4 bg-background rounded-lg sm:rounded-xl md:rounded-2xl border border-outline-variant/5">
                <div className="flex items-center gap-2.5 sm:gap-3 md:gap-4 min-w-0">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
            ...
            <div className="absolute -bottom-4 -right-4 opacity-[0.03] pointer-events-none">
              <span className="material-symbols-outlined text-[100px] sm:text-[120px]" style={{ fontVariationSettings: "'FILL' 1" }}>warning</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 border border-outline-variant/10 shadow-sm relative overflow-hidden">
            ...
            <div className="space-y-3 sm:space-y-4 relative z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3">
                  <span className="material-symbols-outlined text-primary text-sm sm:text-base">arrow_downward</span>
              ...
              <div className="flex items-center justify-between border-t border-outline-variant/10 pt-3 sm:pt-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  <span className="material-symbols-outlined text-primary text-sm sm:text-base">shopping_cart</span>
            ...
            <div className="absolute -bottom-4 -right-4 opacity-[0.03] pointer-events-none">
              <span className="material-symbols-outlined text-[100px] sm:text-[120px]" style={{ fontVariationSettings: "'FILL' 1" }}>history</span>
            </div>
          </div>
        </div>

        {/* Quick Actions */}
        <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 border border-outline-variant/10 shadow-sm flex flex-col h-fit lg:sticky lg:top-8 relative overflow-hidden">
          ...
          <div className="flex flex-col gap-2 sm:gap-3 relative z-10">
            {[
              ...
              <button key={label} className="w-full flex items-center justify-between px-3 sm:px-4 md:px-5 py-2.5 sm:py-3 md:py-4 bg-background hover:bg-primary/5 transition-colors rounded-lg sm:rounded-xl md:rounded-2xl border border-outline-variant/5 text-left group">
          ...
          <div className="absolute -bottom-4 -right-4 opacity-[0.03] pointer-events-none">
            <span className="material-symbols-outlined text-[100px] sm:text-[120px]" style={{ fontVariationSettings: "'FILL' 1" }}>bolt</span>
          </div>
        </div>
      </div>
    </div>
