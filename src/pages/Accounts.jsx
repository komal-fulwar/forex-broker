  ...
  return (
    <div className="max-w-6xl mx-auto w-full">
      ...
      <header className="mb-4 sm:mb-6 md:mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-3 sm:gap-4 md:gap-6">
        ...
        <button className="bg-gradient-to-b from-black to-[#141b2c] text-on-primary px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold hover:opacity-90 transition-all shadow-sm w-full sm:w-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
        {/* Real Account */}
        <div className="bg-white shadow-sm rounded-xl p-4 sm:p-5 md:p-6 flex flex-col justify-between min-h-[200px] sm:min-h-[240px] md:min-h-[260px] border border-outline-variant/10 group hover:border-primary/20 transition-all relative">
          ...
          <div>
            <div className="flex justify-between items-start mb-3 sm:mb-4">
              <div className="space-y-0.5">
                <span className="text-[8px] sm:text-[9px] uppercase tracking-widest text-on-surface-variant/50 font-bold">Standard Real</span>
              ...
              <div className="h-8 w-8 sm:h-9 sm:w-9 rounded-lg bg-background flex items-center justify-center text-primary/80">
          ...
          <div className="mt-auto space-y-3 sm:space-y-4">
            ...
            <div className="flex items-center gap-2 pt-3 sm:pt-4 border-t border-outline-variant/5">
              ...
              <button className="flex-1 py-1.5 sm:py-2 text-[10px] sm:text-[11px] font-bold text-on-primary bg-gradient-to-b from-black to-[#141b2c] rounded-lg transition-opacity">Deposit</button>
            </div>
          </div>
        </div>

        {/* Demo Account */}
        <div className="bg-background rounded-xl p-4 sm:p-5 md:p-6 flex flex-col justify-between min-h-[200px] sm:min-h-[240px] md:min-h-[260px] border border-outline-variant/10 group hover:border-secondary/20 transition-all relative">
          <div className="absolute top-3 sm:top-4 md:top-5 right-3 sm:right-4 md:right-5">
        ...
        {/* Add Account */}
        <div className="bg-white shadow-sm rounded-xl p-4 sm:p-5 md:p-6 flex flex-col items-center justify-center border-2 border-dashed border-outline-variant/20 text-center space-y-3 sm:space-y-4 min-h-[200px] sm:min-h-[240px] md:min-h-[260px] hover:border-outline-variant/40 transition-colors cursor-pointer group">
          <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-background flex items-center justify-center text-on-surface-variant/30 group-hover:text-primary transition-colors">
          ...
          <button className="text-secondary font-bold text-[10px] sm:text-[11px] hover:underline underline-offset-4 tracking-tight">Explore Options</button>
        </div>
      </div>
      ...
      <section className="mt-8 sm:mt-12 md:mt-20 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-16 items-center">
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6">
            <div className="space-y-0.5 sm:space-y-1">
              <p className="text-base sm:text-lg font-bold text-on-surface">0.0 Pips</p>
              <p className="text-[10px] sm:text-[11px] text-on-surface-variant">Raw spreads on pro accounts.</p>
            </div>
            <div className="space-y-0.5 sm:space-y-1">
              <p className="text-base sm:text-lg font-bold text-on-surface">500:1</p>
        ...
        <div className="bg-background rounded-xl p-5 sm:p-6 md:p-8 relative overflow-hidden border border-outline-variant/10">
          <div className="relative z-10">
            <p className="text-[8px] sm:text-[9px] uppercase tracking-widest text-secondary font-bold mb-2 sm:mb-3">Security &amp; Trust</p>
            ...
            <div className="mt-4 sm:mt-6 flex items-center gap-2 sm:gap-3">
              <div className="h-0.5 w-6 sm:w-8 bg-secondary/40 rounded-full"></div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-primary/20 backdrop-blur-sm p-3 sm:p-4" onClick={() => setShowModal(false)}>
          <div className="bg-white shadow-lg rounded-xl w-full max-w-sm p-4 sm:p-5 md:p-6 space-y-4 sm:space-y-5 md:space-y-6 border border-outline-variant/10 relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="pt-3 sm:pt-4 flex gap-2 sm:gap-3">
              ...
              <button className="flex-1 py-2 sm:py-2.5 text-[10px] sm:text-xs font-bold text-on-primary bg-gradient-to-b from-black to-[#141b2c] rounded-lg transition-opacity">Save Changes</button>
            </div>
          </div>
        </div>
      )}
